...
$(document).ready(function(){
	...
	var height = $('#contact_us').innerHeight();
	var windowHeight = $(window).height();
	var navHeight = $('.top-navbar').innerHeight();
	var siblingHeight = $('#contact_us').nextAll().innerHeight();
	...
	$('.top-navbar a').click(function(event){
